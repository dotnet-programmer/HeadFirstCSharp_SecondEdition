...
namespace Organizacja_przyjecia_3
{
	public partial class Form1 : Form
	{
		...
		private void NormalPartyValueChanged(object sender, EventArgs e) => LbTotalCost.Text = CalculateCost(true, (int)NmNumberOfPeople.Value, ChDecoration.Checked, ChHealthyOption.Checked).ToString();

		private void BirthdayPartyValueChanged(object sender, EventArgs e) => LbTotalCostBth.Text = CalculateCost(false, (int)NmNumberOfPeopleBth.Value, ChDecorationBth.Checked).ToString();
