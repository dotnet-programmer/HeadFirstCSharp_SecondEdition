namespace Organizacja_przyjecia_3
{
	partial class Form1
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.tabControl1.Size = new System.Drawing.Size(286, 193);
			...
			this.tabPage1.Size = new System.Drawing.Size(278, 167);
			...
			this.ChHealthyOption.CheckedChanged += new System.EventHandler(this.NormalPartyValueChanged);
			// 
			// ChDecoration
			// 
			...
			this.ChDecoration.CheckedChanged += new System.EventHandler(this.NormalPartyValueChanged);
			// 
			// NmNumberOfPeople
			// 
            ...
            0,
            0});
			this.NmNumberOfPeople.ValueChanged += new System.EventHandler(this.NormalPartyValueChanged);
			// 
			// label1
			// 
			...
			this.tabPage2.Size = new System.Drawing.Size(278, 167);
			...
			this.TxtCakeWriting.TextChanged += new System.EventHandler(this.BirthdayPartyValueChanged);
			// 
			// label6
			// 
			...
			this.ChDecorationBth.CheckedChanged += new System.EventHandler(this.BirthdayPartyValueChanged);
			// 
			// NmNumberOfPeopleBth
			// 
            ...
            0,
            0});
			this.NmNumberOfPeopleBth.ValueChanged += new System.EventHandler(this.BirthdayPartyValueChanged);
			// 
			// label5
			// 
